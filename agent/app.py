...
async def main():
    ...
    await collect_tools(ums_mcp_client, tools, tool_name_client_map)

    fetch_mcp_client = await CustomMCPClient.create(
        "https://remote.mcpservers.org/fetch/mcp"
    )
    await collect_tools(fetch_mcp_client, tools, tool_name_client_map)
